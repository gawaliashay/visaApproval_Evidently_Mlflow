...
class DataTransformationConfig:
    ...
    transformed_train_file_path: str = os.path.join(
        data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, TRANSFORMED_TRAIN_FILE_NAME
    )
    transformed_test_file_path: str = os.path.join(
        data_transformation_dir, DATA_TRANSFORMATION_TRANSFORMED_DATA_DIR, TRANSFORMED_TEST_FILE_NAME
    )
...
# ModelPusherConfig: Configuration for pushing the model to S3
@dataclass
...
# USvisaPredictorConfig: Configuration for making predictions using the trained model
@dataclass
